...
- L'idée était de créer un séquencer simple dans lequel je créerais des mesures à la volé, 2 temps, 3 temps, 4 temps, 5 temps etc... Que chaque mesure pourrait être divisée un subdivisions, à la noire , la croche, triolets etc...
- L'appli le permet et bien plus. On peut réduire le tempo, l'augmenter, mettre des couleurs par couplet, refrain etc...
- Et surtout, on peut lancer la lecture via un PC venant de ma WING quand je mets en lecture mon playback. Si tempo bien en place, pas de soucis, j'ai juste mis une compensention ou retard à l'allumage (250ms était la bonne valeur)
